...
@export var npc_id = "bedmite_npc"  # Unique ID for this NPC
...
@export var dialog_lines_stage1 = [
	"Have you found any trade-worthy dust sources?"
]

@export var npc_name: String = "Dust Mite"
...
func _on_player_entered():
	print("Player entered interaction range with bed mite")
...
func start_dialog():
	...
	if has_node("/root/DialogSystem"):
		print("bed mite: Calling DialogSystem.start_dialog with stage", current_stage, "dialog")
...
func _on_dialog_finished(finished_npc_id):
	print("bed mite received dialog_finished signal for npc_id:", finished_npc_id)
