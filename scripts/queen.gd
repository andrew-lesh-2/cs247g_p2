...
func start_dialog():
	...
	dialog.display_dialog(
		...
		["Is that... it couldn't be... a ladybug?", "My my... how unexpected. You are far from your home, young traveler.
			...
			"How curious... Let's see...", "Ahem...", "To Her Majesty, Queen of the Endless Tunnels, From beyond your earthen halls, a humble creature sends their heart.",
			...
			"— Yours, if you'll have me A Devoted Stranger", "...", "Little ladybug... will you please convey to this stranger that I would like to meet them in seven days time?",
			"I shall be awaiting their presence at the top of the anthill.",  "Thank you for traveling all the way here little ladybug. Now, make haste. I wish you luck on your journey."],
	)
